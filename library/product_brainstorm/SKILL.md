...
description: "[STRATEGY / THE 'WHAT'] Generates high-level feature ideas, experiment designs, and business value hypotheses. Use to figure out what the product should do."
---
...
## Referenced Skills
This command utilizes the following specialized skills. Read their documentation in the `references/` directory for detailed instructions:
- **brainstorm-ideas-new** (`references/brainstorm-ideas-new.md`)
- **brainstorm-ideas-existing** (`references/brainstorm-ideas-existing.md`)
- **prioritize-features** (`references/prioritize-features.md`)
- **identify-assumptions-new** (`references/identify-assumptions-new.md`)
- **brainstorm-experiments-existing** (`references/brainstorm-experiments-existing.md`)
- **brainstorm-experiments-new** (`references/brainstorm-experiments-new.md`)
- **identify-assumptions-existing** (`references/identify-assumptions-existing.md`)
