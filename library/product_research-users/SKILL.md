...
- **market-segments** (`references/market-segments.md`)
- **customer-journey-map** (`references/customer-journey-map.md`)
- **user-segmentation** (`references/user-segmentation.md`)
