# Full Guide for eng_finishing-a-development-branch
...
### Step 1: Verify Tests and Architecture

> [!IMPORTANT]
> **HARD DEPENDENCY:** Before presenting options, you MUST invoke the `product_ship_check` skill (or invoke a subagent with it) to run an architecture audit. You cannot suggest a merge if the architecture check fails.

**After the architecture audit passes, verify tests pass:**
