---
name: product_interview
description: "[TEXT GENERATION] Prepare an interview script or clean/summarize raw transcripts into structured insights. (For routing these insights into the system's memory, use brain_ingest afterwards)."
---
...
- **interview-script** (`references/interview-script.md`)
- **summarize-interview** (`references/summarize-interview.md`)
