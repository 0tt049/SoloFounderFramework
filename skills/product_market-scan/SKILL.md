...
- **ansoff-matrix** (`references/ansoff-matrix.md`)
- **swot-analysis** (`references/swot-analysis.md`)
- **porters-five-forces** (`references/porters-five-forces.md`)
- **pestle-analysis** (`references/pestle-analysis.md`)
